...
public class EditProfileActivity extends AppCompatActivity {
    ...
    MaterialEditText nickname, username, bio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateProfile(nickname.getText().toString(),
...
//                        .setCropShape(CropImageView.CropShape.OVAL)
    ...
    private void updateProfile(String fullname, String username, String bio){
        ...
        Toast.makeText(EditProfileActivity.this, "성공적으로 수정되었습니다!", Toast.LENGTH_SHORT).show();
    }
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(EditProfileActivity.this, "실", Toast.LENGTH_SHORT).show();
                    }
                }
